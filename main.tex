...
\newpage
\input{contents/1introduction}
\input{contents/2gettingstarted}
\input{contents/3dashboardoverview}
\input{contents/4adminfeatures}
% \input{contents/5userfeatures}
\input{contents/7troubleshootingandsupport}
% \input{contents/8appendix}
